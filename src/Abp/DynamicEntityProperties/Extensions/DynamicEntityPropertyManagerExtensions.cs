...
namespace Abp.DynamicEntityProperties.Extensions
{
    public static class DynamicEntityPropertyManagerExtensions
    {
        ...
        public static DynamicEntityProperty Add<TEntity>(this IDynamicEntityPropertyManager manager, int dynamicPropertyId, Guid? tenantId)
            where TEntity : IEntity<int>
        {
            return manager.Add<TEntity, int>(dynamicPropertyId, tenantId);
        }

        public static DynamicEntityProperty Add<TEntity, TPrimaryKey>(this IDynamicEntityPropertyManager manager, int dynamicPropertyId, Guid? tenantId)
            where TEntity : IEntity<TPrimaryKey>
        {
        ...
        public static Task<DynamicEntityProperty> AddAsync<TEntity>(this IDynamicEntityPropertyManager manager, int dynamicPropertyId, Guid? tenantId)
            where TEntity : IEntity<int>
        {
            return manager.AddAsync<TEntity, int>(dynamicPropertyId, tenantId);
        }

        public static async Task<DynamicEntityProperty> AddAsync<TEntity, TPrimaryKey>(this IDynamicEntityPropertyManager manager, int dynamicPropertyId, Guid? tenantId)
            where TEntity : IEntity<TPrimaryKey>
        {
            var entity = new DynamicEntityProperty()
            {
