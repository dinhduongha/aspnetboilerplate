...
namespace Abp.Notifications
{
    ...
    public class NullNotificationStore : INotificationStore
    {
        ...
        public Task<List<NotificationSubscriptionInfo>> GetSubscriptionsAsync(long?[] tenantIds, string notificationName, string entityTypeName, string entityId)
        {
            return Task.FromResult(new List<NotificationSubscriptionInfo>());
        }
        ...
        public Task UpdateUserNotificationStateAsync(long? notificationId, Guid userNotificationId, UserNotificationState state)
        {
            return Task.FromResult(0);
        }
        ...
        public Task DeleteUserNotificationAsync(long? notificationId, Guid userNotificationId)
        {
            return Task.FromResult(0);
        }
        ...
        public Task<UserNotificationInfoWithNotificationInfo> GetUserNotificationWithNotificationOrNullAsync(long? tenantId, Guid userNotificationId)
        {
        ...
        public List<NotificationSubscriptionInfo> GetSubscriptions(long?[] tenantIds, string notificationName, string entityTypeName, string entityId)
        {
            return new List<NotificationSubscriptionInfo>();
        }
        ...
        public void UpdateUserNotificationState(long? tenantId, Guid userNotificationId, UserNotificationState state)
        {
        }
        ...
        public void DeleteUserNotification(long? tenantId, Guid userNotificationId)
        {
        }
        ...
        public UserNotificationInfoWithNotificationInfo GetUserNotificationWithNotificationOrNull(long? tenantId, Guid userNotificationId)
        {
