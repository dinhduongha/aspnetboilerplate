...
namespace Abp.Notifications
{
    ...
    public interface INotificationStore
    {
        ...
        /// </summary>
        Task<List<NotificationSubscriptionInfo>> GetSubscriptionsAsync(long?[] tenantIds, string notificationName, string entityTypeName, string entityId);

        /// <summary>
        /// Gets subscriptions for a notification for specified tenant(s).
        /// </summary>
        List<NotificationSubscriptionInfo> GetSubscriptions(long?[] tenantIds, string notificationName, string entityTypeName, string entityId);
        ...
        /// </summary>
        Task UpdateUserNotificationStateAsync(long? tenantId, Guid userNotificationId, UserNotificationState state);

        /// <summary>
        /// Updates a user notification state.
        /// </summary>
        void UpdateUserNotificationState(long? tenantId, Guid userNotificationId, UserNotificationState state);
        ...
        /// </summary>
        Task DeleteUserNotificationAsync(long? tenantId, Guid userNotificationId);

        /// <summary>
        /// Deletes a user notification.
        /// </summary>
        void DeleteUserNotification(long? tenantId, Guid userNotificationId);
        ...
        Task<UserNotificationInfoWithNotificationInfo> GetUserNotificationWithNotificationOrNullAsync(long? tenantId, Guid userNotificationId);
        ...
        /// <param name="tenantId">Tenant Id</param>
        /// <param name="userNotificationId">Skip count.</param>
        UserNotificationInfoWithNotificationInfo GetUserNotificationWithNotificationOrNull(long? tenantId, Guid userNotificationId);
