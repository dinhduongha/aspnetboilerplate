...
namespace Abp.Notifications
{
    ...
    public class UserNotificationManager : IUserNotificationManager, ISingletonDependency
    {
        ...
        public async Task<UserNotification> GetUserNotificationAsync(long? tenantId, Guid userNotificationId)
        {
        ...
        public UserNotification GetUserNotification(long? tenantId, Guid userNotificationId)
        {
        ...
        public Task UpdateUserNotificationStateAsync(long? tenantId, Guid userNotificationId, UserNotificationState state)
        {
        ...
        public Task DeleteUserNotificationAsync(long? tenantId, Guid userNotificationId)
        {
