...
namespace Abp.Localization
{
    ...
    public interface IApplicationLanguageTextManager
    {
        ...
        string GetStringOrNull(long? tenantId, string sourceName, CultureInfo culture, string key, bool tryDefaults = true);
        ...
        /// <param name="tryDefaults">True: fallbacks to default languages if can not find in given culture</param>
        List<string> GetStringsOrNull(long? tenantId, string sourceName, CultureInfo culture, List<string> keys, bool tryDefaults = true);
        ...
        Task UpdateStringAsync(long? tenantId, string sourceName, CultureInfo culture, string key, string value);
    }
}
