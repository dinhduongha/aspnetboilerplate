...
namespace Abp.Localization
{
    ...
    public interface IMultiTenantLocalizationSource : ILocalizationSource
    {
        ...
        string GetString(long? tenantId, string name, CultureInfo culture);
        ...
        string GetStringOrNull(long? tenantId, string name, CultureInfo culture, bool tryDefaults = true);
        ...
        /// <param name="culture">Culture</param>
        List<string> GetStrings(long? tenantId, List<string> names, CultureInfo culture);
        ...
        /// <param name="culture">Culture</param>
        /// <param name="tryDefaults">True: fallbacks to default languages if can not find in given culture</param>
        List<string> GetStringsOrNull(long? tenantId, List<string> names, CultureInfo culture, bool tryDefaults = true);
    }
}
