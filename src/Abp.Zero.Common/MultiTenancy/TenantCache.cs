...
namespace Abp.MultiTenancy
{
        ...
        where TUser : AbpUserBase
    {
        ...
        public virtual async Task<TenantCacheItem> GetAsync(long tenantId)
        {
        ...
        public virtual async Task<TenantCacheItem> GetOrNullAsync(long tenantId)
        {
        ...
        [UnitOfWork]
        protected virtual async Task<TTenant> GetTenantOrNullAsync(long tenantId)
        {
            using (_unitOfWorkManager.Current.SetTenantId(null))
            {
