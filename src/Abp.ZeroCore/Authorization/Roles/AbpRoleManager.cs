...
namespace Abp.Authorization.Roles
{
        ...
        where TUser : AbpUser<TUser>
    {
        ...
        public virtual async Task AddToOrganizationUnitAsync(int roleId, long ouId, long? tenantId)
        {
            await AddToOrganizationUnitAsync(
                await GetRoleByIdAsync(roleId),
                await _organizationUnitRepository.GetAsync(ouId)
        ...
        protected virtual TRole MapStaticRoleDefinitionToRole(long tenantId, StaticRoleDefinition staticRoleDefinition)
        {
            return new TRole
            {
                TenantId = tenantId,
