...
namespace Abp.Zero.Ldap.Configuration
{
    ...
    public class LdapSettings : ILdapSettings, ITransientDependency
    {
        ...
        public virtual Task<bool> GetIsEnabled(long? tenantId)
        {
        ...
        public virtual async Task<ContextType> GetContextType(long? tenantId)
        {
            return tenantId.HasValue
        ...
        public virtual Task<string> GetContainer(long? tenantId)
        {
            return tenantId.HasValue
        ...
        public virtual Task<string> GetDomain(long? tenantId)
        {
            return tenantId.HasValue
        ...
        public virtual Task<string> GetUserName(long? tenantId)
        {
            return tenantId.HasValue
        ...
        public virtual Task<string> GetPassword(long? tenantId)
        {
            return tenantId.HasValue
