...
namespace Abp.AspNetCore.Tests
{
    public class MultiTenancy_Tests : AppTestBase
    {
        ...
        {
            Client.DefaultRequestHeaders.Add("Cookie", new CookieHeaderValue(_multiTenancyConfig.TenantIdResolveKey, "00000000-0000-0000-0000-000000000043").ToString());
            Client.DefaultRequestHeaders.Add(_multiTenancyConfig.TenantIdResolveKey, "00000000-0000-0000-0000-000000000042");
        ...
        [Theory]
        [InlineData("http://{TENANCY_NAME}.mysite.com", "http://default.mysite.com", "00000000-0000-0000-0000-000000000001")]
        [InlineData("http://{TENANCY_NAME}.mysite.com:8080", "http://default.mysite.com:8080", "00000000-0000-0000-0000-000000000001")]
        [InlineData("http://{TENANCY_NAME}.mysite.com/", "http://default.mysite.com/", "00000000-0000-0000-0000-000000000001")]
        [InlineData("http://{TENANCY_NAME}.mysite.com/host", "http://default.mysite.com/host", "00000000-0000-0000-0000-000000000001")]
        [InlineData("http://{TENANCY_NAME}:80", "http://default:80", "00000000-0000-0000-0000-000000000001")]
