...
namespace Abp.Tests.RealTime
{
    public class InMemoryOnlineClientStore_Tests
    {
        ...
        public void Test_All()
        {
            ...
            _store.Add(new OnlineClient(connectionId, "127.0.0.1", 1, new Guid("0171ac9f-3856-1611-0112-2edb41a5dab0")));
            ...
            _chatStore.Add(new OnlineClient(connectionId, "127.0.0.1", 1, new Guid("0171ac9f-3856-1611-0112-2edb41a5dab0")));
