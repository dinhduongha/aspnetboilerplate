...
namespace Abp.Zero.SampleApp.Tests.Webhooks
{
    ...
    {
        private WebhookSubscription NewWebhookSubscription(long? tenantId, params string[] webhookDefinitions)
        {
        ...
        private WebhookSubscription NewWebhookSubscription(string seed, long? tenantId, params string[] webhookDefinitions)
        {
            return new WebhookSubscription
            {
                TenantId = tenantId,
